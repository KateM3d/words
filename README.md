...
Starts the json server with data
...
The purpose of the app is to help people learn foreign language (French) by using Flashcards.
...
Stack: React, React hooks, React Router, JSX, SCSS/SASS, Json-Server, GSAP animation, Context API.
